 ...
 *
 */
int ll_add(LinkedList* this, void* pElement)//agrega nuevo elemento al final
{
	//int returnAux = -1;

	return addNode(this, ll_len(this), pElement);//lugar al final del tren
...
void* ll_get(LinkedList* this, int index)
{
	...
	return returnAux;
	//returAux = getNode(this, index)->pElement;
}
...
int ll_remove(LinkedList* this,int index)
{
	...
	if(this!=NULL && index > -1 && index < ll_len(this))
	{
		...
		free(pNodo);//se libera el nodo, no a lo que apunta
...
int ll_indexOf(LinkedList* this, void* pElement)
{
	...
	if(this!=NULL)
	{
		...
		{
			pElementAux = ll_get(this, i);//hacerlo on the fly para practicar
...
int ll_isEmpty(LinkedList* this)
{
	...
	int returnAux = -1;
	if(this != NULL){
		returnAux = this->pFirstNode == NULL; //esta comparando
	}
	return returnAux;
}
...
int ll_contains(LinkedList* this, void* pElement)
{
	...
	if(this != NULL){
		...
		//if(ll_indexOf(this, pElement) >= 0){
			//returnAux = 1;
			returnAux = ll_indexOf(this, pElement) >= 0?1:0; //operador ternario: condicion, valor de true y valor de false
		//}
	}
	return returnAux;
}
